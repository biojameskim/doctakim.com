...
const BlogImage = ({ src, alt, caption, caption2, orientation, maxW = '400px' }: { src: string, alt: string, caption?: string, caption2?: string, orientation?: string, maxW?: string }) => {
  return (
    <Box pt='5vh' pb='2vh' maxWidth={orientation === 'h' ? '600px' : maxW} alignSelf='center'>
