    ...
    <div>
      ...
      <div className='blog-text'>
        ...
        <Stack spacing={7} width={{ base: '85%', md: '60%' }} fontSize={{ base: 'md', md: 'lg' }} fontFamily='century'>
          ...
          <Text>But lately, I’ve been thinking more about what it'd be like to have a younger sister.</Text>

          <Text fontWeight='bold' paddingY={'7vh'}>—</Text>

          <Text>Growing up, my brother and I wanted to be world-class youtubers.</Text>
          <Text>A lot of our time after school was consumed by brainstorming new video ideas and recording new scenes.</Text>
          <Text pb='7vh'>Since both of us were the screenwriters, directors, and actors for our videos,</Text>

          <Text pb='7vh'>We <em>really</em> could’ve used a cameraman.</Text>

          <Text>Though I guess if our sister really wanted, we could’ve let her have a cameo in one of our films too.</Text>
          ...
          <Text>Eventually, we realized we had no talent for screenwriting, directing, or acting.</Text>
          ...
          <Text>There was this new app called Instagram and we posted pictures of the coolest poses we could think of.</Text>
          ...
          <Text>Not that our poses weren’t cool, but our sister would’ve definitely helped us pose so much better.</Text>
          <Text>And back in the past, me and my brother used to be pretty darn crusty.</Text>
          ...
          <Text>When the ultrasound technician told my parents that I was a boy back in ‘02,</Text>
          ...
          <Text>and I worked hard in high school because I saw him working hard first.</Text>
          <Text>I’ve relied on my brother before I even knew he was my brother.</Text>
          <Text> Even now, I ask for his opinion on things even as small as which color t-shirt I should wear today.</Text>
          ...
          <Text pb='7vh'>I wish I could be that same loving role model for my younger sister.</Text>

          <Text>Someone that listens without interruption.</Text>
          <Text>Someone that compliments and encourages but also disciplines when needed.</Text>
          <Text>Someone that reminds her constantly that she’s loved and cared for.</Text>
          ...
          <Text>And most importantly, I think I could’ve given my sister some <em><Text as='b'>great</Text></em> advice.</Text>
          <Text>From questions about academics, faith, friendships, and even questions about dating,</Text>
          ...
          <Text pb='4vh'>What’s his full name, what’s his age, where does he go to school, and what do his parents do?</Text>

          <Text as='i' fontSize='xl' paddingLeft={'2rem'}>“I think about him all the time and I get butterflies in my stomach every time I see him. I just want to be with him. Does this mean I like him?”</Text>
          <Text pb='4vh'>I don’t think so.</Text>

          <Text as='i' fontSize='xl' paddingLeft={'2rem'}>“I’m sure I like him. I think I’m gonna go for it.”</Text>
          ...
          <Text>I read in a book somewhere that said kids are a breath of fresh air because they live in the present.</Text>
          <Text pb='5vh'>They don’t care about yesterday’s mistakes or worry about what tomorrow will bring—</Text>
          <Text pb='7vh'>They’re already onto finding the next fun thing that’ll bring them joy in the present.</Text>
          ...
          <Text>Every Sunday, I hang out with the little kids at my church and I’ve seen them grow up over a couple years now.</Text>
          <Text pb='7vh'>And most of them lose the bright, contagious energy they once had.</Text>

          <Text>They start to be self-conscious about yesterday’s mistakes and worry about how their peers will view them tomorrow.</Text>
          ...
          <Text>As I witness the kids go through this process, I can’t help but see parts of my younger self in them.</Text>

          <Text>And there’s so many things I wish I could tell my younger self:</Text>
          <Text>To have more confidence,</Text>
          <Text pb='7vh'>And that a lot of things aren’t as big of a deal as I made them to be.</Text>

          <Text>I wish I could affirm my sister in these things so she wouldn’t lose sight of her boldness like I once did.</Text>

          <Text fontWeight='bold' paddingY={'7vh'}>—</Text>

          <Text>I also can’t help but think what it would be like if one of these little girls was my younger sister.</Text>
          <Text pb='7vh'>Judging by how they interact with me, I think they would’ve liked me as an older brother too.</Text>
          ...
          <Text>Since my mom doesn’t play, she usually sits on the benches to the side and watches us.</Text>
          ...
          <Text pb='7vh'>There’s only a limit to the way us three guys can comfort Mom.</Text>

          <Text>I wish someone could try on outfits with her and pick out jewelry for her.</Text>
          <Text>I wish someone could put on makeup with her and paint her nails for her.</Text>
          <Text>And even if it’s just for a moment,</Text>
          <Text pb='7vh'>I wish someone could make my mom feel like she’s back in college, hanging out with her girl friends.</Text>
          ...
          <Text>Up until now and probably for the rest of my life, it’ll just be me and my bro.</Text>
          <Text> But I’m happy with that and I’m thankful for the family dynamic that we have.</Text>
          <Text>And even though I couldn’t be that daughter for my parents,</Text>
          <Text pb='7vh'>Not having a sister has taught me to be more in tune with my mom’s emotions.</Text >
          ...
          <Text>And you’ve ever wanted to have two cool, overprotective older brothers,</Text >
