    ...
    <div>
      ...
      <div className='blog-text'>
        ...
        <Stack
          ...
          <Text>When the ultrasound technician told my parents that I was a boy
            back in ‘02,</Text>
          ...
          <Text>and I worked hard in high school because I saw him working hard
            first.</Text>
          <Text>I’ve relied on my brother before I even knew he was my brother.</Text>
          <Text> Even now, I ask for his opinion on things even as small as which
            color t-shirt I should wear today.</Text>
          ...
          <Text>Someone that compliments and encourages but also disciplines when
            needed.</Text>
          ...
          <Text pb='4vh'>What’s his full name, what’s his age, where does he go
            to school, and what do his parents do?</Text>

          <Text as='i' fontSize='xl' paddingLeft={'2rem'}>“I think about him all
            the time and I get butterflies in my stomach every time I see him. I just
            want to be with him. Does this mean I like him?”</Text>
          <Text pb='4vh'>I don’t think so.</Text>

          <Text as='i' fontSize='xl' paddingLeft={'2rem'}>“I’m sure I like him.
            I think I’m gonna go for it.”</Text>
          ...
          <Text>As I witness the kids go through this process, I can’t help but
            see parts of my younger self in them.</Text>
          ...
          <Text>I wish I could affirm my sister in these things so she wouldn’t
            lose sight of her boldness like I once did.</Text>
