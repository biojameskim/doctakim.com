    ...
    <div>
      ...
      <div className='blog-text'>
        ...
        <Stack
          ...
          <Text pb='5vh'>Her hair wasn’t tied back in the usual ponytail, but it
          ...
          <Text pb='5vh'>My aunt isn't completely the same young and vibrant
            person I knew.</Text>
          ...
          <Text>In the grand scheme of things, one year really isn’t that long
            of a time.</Text>
          <Text pb='5vh'>But the span of a year has fragmented my memory of my
            grandparents.</Text>
          ...
          <Text pb='5vh'>Yet even in these small fragments of time, there’s a
            lot of change.</Text>
          ...
          <Text pb='5vh'>But this summer, my grandpa apologized for not being
          ...
          <Text pb='5vh'>They even used to call me oppa (older brother in Korean)
          ...
          <Text pb='5vh'>Every time they share something new and exciting, I’m
            happy for them, but it also stings a little inside.</Text>

          <Text>I’m coming to terms with the fact that my baby cousins are no
            longer babies.</Text>
          <Text pb='5vh'>They’re not afraid to share their own thoughts and
            feelings, even
          ...
          <Text pb='5vh'>But that was always for later. I’d work towards these things when
          ...
          <Text pb='5vh'>I’m slowly realizing how much more intentional and diligent I
