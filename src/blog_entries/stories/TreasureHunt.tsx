    ...
    <div>
      ...
      <div className='blog-text'>
        ...
        <Stack
          ...
          <Text>I think they call it “the Lawn” or something like that, but it
          ...
          <Text pb='5vh'>He reassured us that if we were ever to go back to Boston,
            he would tell us where to go to find it.</Text>

          <Text>But what kind of a treasure could you possibly hide on a college
            campus?</Text>
          <Text>I always thought he was joking and him telling us to go find that
            treasure was just his way of saying</Text>
          ...
          <Text>Ever since I was in elementary school, my dad took me and my brother out to the park to play tennis with him.</Text >
          <Text pb='5vh'>As someone who’s emotionally reserved, tennis was an outlet for my dad to share his passion with his kids, and a way for him to bond with us.</Text >
          ...
          <Text pb='5vh'>It was just another email, to let me know how he’s doing and to ask how I’m doing.</Text >
          ...
          <Text as='i' pb='10vh'>“Dad, what’s the treasure you hid at MIT ?”</Text >
          ...
          <Text>I want to appreciate how much color the mundane adds to my life.</Text >
          ...
          <Text pb='10vh'>At least <em>not yet.</em></Text>
