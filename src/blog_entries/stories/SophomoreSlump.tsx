    ...
    <div>
      ...
      <div className="blog-text">
        ...
        >
          ...
          <Text>
            One year ago, I was nervous whether I’d be able to find people I
            could call my friends.
          </Text>
          <Text>
            Fast forward one year, and there were people that made me excited to
            go back to Ithaca again.
          </Text>
          ...
          <Text pb="5vh">
            so I started waking up earlier every day to get breakfast before
            going to class.
          </Text>

          <Text>
            Elisabeth always said she’d join me but she usually didn’t wake up
            in time,
          </Text>
          ...
          <Text>
            I made sure to sleep before 2 every night, went vegetarian for a
            month, and I even started exercising pretty consistently too.
          </Text>
          ...
          <Text>
            But if there was one thing I was most excited for about sophomore
            year, it was meeting the new freshmen.
          </Text>
          <Text>
            My Christian fellowship did a lot of events to reach out to new
            students and for one of them, we gave out free ice pops.
          </Text>
          ...
          <Text>
            As I met a lot of different freshmen, I couldn’t help but wonder
            who’d be the ones that’d stay.
          </Text>
          ...
          <Text>
            Soon enough, a lot of freshmen started to roll in and some of them
            were <i>super</i> caring.
          </Text>
          ...
          <Text>
            And sometime early on, I got really close to this freshman named
            Jonah.{" "}
          </Text>
          ...
          <Text>
            Every time we had dinner together, we’d sit there for hours talking
            about life, relationships, our futures, and all our hidden secrets.
          </Text>
          <Text>
            Our conversations were usually cut short because the dining hall was
            closing.
          </Text>
          <Text>
            I don’t really remember how we got close, but I think it was our
            shared intellectual curiosity that drew us closer.
          </Text>
          ...
          <Text pb="5vh">
            If you ever talk to Jonah, you’ll quickly find out he’s a bit
            peculiar.
          </Text>
          ...
          <Text pb="5vh">
            I learned <i>a lot</i> freshman year and sophomore year was no
            different.
          </Text>
          ...
          <Text>
            Whenever I was busy and needed to study, there was always some
            hangout or event that popped up out of nowhere.
          </Text>
          <Text>
            Of course I still studied when I really had to, but it didn’t help
            when Elisabeth kept telling me,
          </Text>

          <Text
            as="i"
            paddingY={"5vh"}
            paddingX={{ base: "1.75rem", md: "3.5rem" }}
          >
            “10 years down the road, are you gonna remember the times you
            studied or the spontaneous memories you chose to make instead?”
          </Text>

          <Text>
            This mentality didn’t always justify the best decisions, but it’s
            only been a couple months down the road, and the happy memories are
            all I remember.
          </Text>
          ...
          <Text>
            It was the spontaneous decisions that led to the most memorable
            trips,
          </Text>
          ...
          <Text>
            And also a time where unexpected friendships led to some really
            great conversations.
          </Text>
          ...
          <Text pb="5vh">
            But even with all these changes, a lot of things also stayed the
            same.
          </Text>
          ...
          <Text>
            I also thought that being a sophomore meant that the upperclassmen
            would stop spoiling me.
          </Text>
          ...
          <Text>
            That’s when it really hit me that they’d be leaving me in a couple
            months.
          </Text>
          ...
          <Text>
            Time flew by a little quicker than I wanted, and it was already time
            to say goodbye.
          </Text>
          <Text pb="5vh">
            There were some tears, and <i>a lot</i> of hugs.
          </Text>

          <Text>
            A lot of these seniors were the first to welcome me into Cornell,
          ...
          <Text pb="5vh">
            I think what saddens me the most is the fact that I’ll never be able
            to see them as consistently and conveniently as I did for the past
            two years.
          </Text>

          <Text>A good conversation was always just a meal away,</Text>
          <Text>
            But the meals we once had together seem just a little further away
            now.
          </Text>
          ...
          <Text>
            But it gives me comfort knowing that a new group of people will get
            to experience the same love and care they showed me.
          </Text>
          ...
          <Text pb="5vh">
            I still remember when my family dropped him off at Berkeley for his
            freshman year and how I cried on the drive back home.
          </Text>
          ...
          <Text pb="5vh">
            But looking back, every one of those moments have come together to
            define exactly half of my college experience.
          </Text>
          ...
          <Text>
            My Dad always told me that there’s nothing you <i>really</i> have to
            do in life.
          </Text>
          <Text>
            He said as long as I work hard while enjoying every moment, I’ll
            find myself closer to the things I want to do and the direction I
            want to go.
          </Text>
          <Text pb="5vh">
          ...
          <Text>
            But sophomore year was also a time where I found more direction in
            my life.
          </Text>
          <Text>
            In the midst of developing and deepening friendships, grinding out
            psets and projects, and trying new and uncomfortable things, I’ve
            been working hard.
          </Text>
          <Text pb="5vh">But I’ve also been enjoying every moment.</Text>

          <Text>
            And through my failures and successes, I’m slowly realizing what I
          ...
          <Text pb="5vh">
            There were times where I felt overwhelmed by the pace of everything
            around me, and there were friends that I lost in the midst of that
            pace.
          </Text>
          ...
          <Text>
            I’m realizing more and more that I’m still so far from the person I
            want to be.
          </Text>
          ...
          <Text>
            In just a few months, I’ll be back to start my junior year of
            college.
          </Text>
          <Text>
            The past two years really changed me a lot, and I’m curious to see
            how my thoughts and emotions will continue to change.
          </Text>
          <Text pb="5vh">
            I’m curious to know what experiences and memories will come to
            define the highs and lows of my junior year.
          </Text>
